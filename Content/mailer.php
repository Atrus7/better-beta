...
$user = 'santos22'; // place SG username here
$pass = 'gone6300'; // place SG password here
...
$params = array(
    'api_user'  => "$user",
    'api_key'   => "$pass",
    'to'        => "rmoreno@rmoreno.net", // set TO address to have the contact form's email content sent to
